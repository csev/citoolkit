...
Sub approve_onenter()
	...
	Randomize
	Response.Redirect "event.asp?ID=" & cstr(rnd(100))
End Sub
...
<OBJECT classid="clsid:8CC35CD6-E98B-11D0-B218-00A0C92764F5" id=PageObject1 style="LEFT: 0px; TOP: 0px">
	...
	<PARAM NAME="State" VALUE="(ObjectName_Unmatched=\qapprove\q,NavigateMethods=(Rows=0),ExecuteMethods=(Rows=0),Properties=(Rows=0),References=(Rows=0))"></OBJECT>
-->
...
if (typeof approve_onbeforeserverevent == 'function' || typeof approve_onbeforeserverevent == 'unknown')
	thisPage.advise('onbeforeserverevent', 'approve_onbeforeserverevent()');

approve = thisPage;
approve.location = "../Admin/approve.asp";
approve.navigate = new Object;
approve.navigate.show = Function('thisPage.invokeMethod("", "show", this.show.arguments);');
</SCRIPT>
<%
End Sub
%>
...
approve.location = "../Admin/approve.asp";
approve.navigate = new Object;
approve.navigate.show = Function('return;');

	thisPage._objEventManager.adviseDefaultHandler('approve','onenter');
	thisPage._objEventManager.adviseDefaultHandler('approve','onexit');
	thisPage._objEventManager.adviseDefaultHandler('approve','onshow');

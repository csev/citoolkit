...
<OBJECT classid="clsid:8CC35CD6-E98B-11D0-B218-00A0C92764F5" id=PageObject1 style="LEFT: 0px; TOP: 0px">
	...
	<PARAM NAME="State" VALUE="(ObjectName_Unmatched=\qForumsEdit\q,NavigateMethods=(Rows=0),ExecuteMethods=(Rows=0),Properties=(Rows=0),References=(Rows=0))"></OBJECT>
-->
...
if (typeof ForumsEdit_onbeforeserverevent == 'function' || typeof ForumsEdit_onbeforeserverevent == 'unknown')
	thisPage.advise('onbeforeserverevent', 'ForumsEdit_onbeforeserverevent()');

ForumsEdit = thisPage;
ForumsEdit.location = "../Admin/ForumsEdit.asp";
ForumsEdit.navigate = new Object;
ForumsEdit.navigate.show = Function('thisPage.invokeMethod("", "show", this.show.arguments);');
</SCRIPT>
<%
End Sub
%>
...
ForumsEdit.location = "../Admin/ForumsEdit.asp";
ForumsEdit.navigate = new Object;
ForumsEdit.navigate.show = Function('return;');

	thisPage._objEventManager.adviseDefaultHandler('ForumsEdit','onenter');
	thisPage._objEventManager.adviseDefaultHandler('ForumsEdit','onexit');
	thisPage._objEventManager.adviseDefaultHandler('ForumsEdit','onshow');
...
<OBJECT classid="clsid:B5F0E469-DC5F-11D0-9846-0000F8027CA0" height=19 id=Textbox1 
	style="HEIGHT: 19px; LEFT: 10px; TOP: 170px; WIDTH: 300px" width=300>
...
<OBJECT classid="clsid:B5F0E469-DC5F-11D0-9846-0000F8027CA0" height=39 id=Textbox2 
	style="HEIGHT: 39px; LEFT: 10px; TOP: 189px; WIDTH: 300px" width=300>
	<PARAM NAME="_ExtentX" VALUE="7938">
...
<OBJECT classid="clsid:B5F0E46C-DC5F-11D0-9846-0000F8027CA0" height=27 id=Checkbox1 
	style="HEIGHT: 27px; LEFT: 10px; TOP: 208px; WIDTH: 29px" width=29>
...
<OBJECT classid="clsid:B6FC3A14-F837-11D0-9CC8-006008058731" height=27 id=btnUpdate 
	style="HEIGHT: 27px; LEFT: 10px; TOP: 255px; WIDTH: 67px" width=67>

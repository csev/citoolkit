...
Sub ForumsApprove_onenter()
	Recordset1.setSQLText("SELECT * FROM MESSAGES WHERE MESSAGEID="& cstr(Request.QueryString("MESSAGEID")))
	Recordset1.open
	Recordset1.fields.setValue "ApproveUserID", Session("UserID")
	Recordset1.fields.setValue "ApproveDate", cstr(Date()) 
	Recordset1.updateRecord
	Randomize
	Response.Redirect "Forums.asp?ID=" & cstr(rnd(100))
End Sub
...
<OBJECT classid="clsid:8CC35CD6-E98B-11D0-B218-00A0C92764F5" id=PageObject1 style="LEFT: 0px; TOP: 0px">
	...
	<PARAM NAME="State" VALUE="(ObjectName_Unmatched=\qForumsApprove\q,NavigateMethods=(Rows=0),ExecuteMethods=(Rows=0),Properties=(Rows=0),References=(Rows=0))"></OBJECT>
-->
<SCRIPT LANGUAGE=JavaScript RUNAT=SERVER>
/* VIPM PAGE DESCRIPTION
<DSC NAME="ForumsApprove">
...
if (typeof ForumsApprove_onbeforeserverevent == 'function' || typeof ForumsApprove_onbeforeserverevent == 'unknown')
	thisPage.advise('onbeforeserverevent', 'ForumsApprove_onbeforeserverevent()');

ForumsApprove = thisPage;
ForumsApprove.location = "../Admin/ForumsApprove.asp";
ForumsApprove.navigate = new Object;
ForumsApprove.navigate.show = Function('thisPage.invokeMethod("", "show", this.show.arguments);');
</SCRIPT>
<%
End Sub
%>
...
ForumsApprove.location = "../Admin/ForumsApprove.asp";
ForumsApprove.navigate = new Object;
ForumsApprove.navigate.show = Function('return;');

	thisPage._objEventManager.adviseDefaultHandler('ForumsApprove','onenter');
	thisPage._objEventManager.adviseDefaultHandler('ForumsApprove','onexit');
	thisPage._objEventManager.adviseDefaultHandler('ForumsApprove','onshow');
...
<OBJECT classid="clsid:9CF5D7C2-EC10-11D0-9862-0000F8027CA0" id=Recordset1 style="LEFT: 0px; TOP: 0px">
	...
	<PARAM NAME="State" VALUE="(TCConn=\qConnection1\q,TCDBObject=\qTables\q,TCDBObjectName=\qMessages\q,TCControlID_Unmatched=\qRecordset1\q,TCPPConn=\qConnection1\q,RCDBObject=\qRCDBObject\q,TCPPDBObject=\qTables\q,TCPPDBObjectName=\qMessages\q,TCCursorType=\q3\s-\sStatic\q,TCCursorLocation=\q3\s-\sUse\sclient-side\scursors\q,TCLockType=\q3\s-\sOptimistic\q,TCCacheSize_Unmatched=\q10\q,TCCommTimeout_Unmatched=\q10\q,CCPrepared=0,CCAllRecords=1,TCNRecords_Unmatched=\q10\q,TCODBCSyntax_Unmatched=\q\q,TCHTargetPlatform=\q\q,TCHTargetBrowser_Unmatched=\qServer\s(ASP)\q,TCTargetPlatform=\qInherit\sfrom\spage\q,RCCache=\qRCBookPage\q,CCOpen=0,GCParameters=(Rows=0))">
